                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span6">
                                    <table class="">
                                        <tbody>
                                        <tr>
                                            <td><h4>Name: {{$orders->user->name}}</h4></td>
                                        </tr>
                                        <tr>
                                            <td class="width30">Payment ID:</td>
                                            <td class="width70"><strong>{{$orders->payment_id}}</strong></td>
                                        </tr>
                                        <tr>
                                            <td>Address</td>
                                        </tr>
                                ...
                                <div class="span6">
                                    @foreach($orders->orderItems as $item)
                                        <form action="{{route('toggle.deliver',$orders->id)}}" method="POST">
                                            {{csrf_field()}}
                                    <table class="table table-bordered table-invoice">
                                        <div class="control-group pull-right">
                                            <label class="control-label">Delivered</label>
                                            <div class="controls">
                                                <input type="checkbox" value="1" name="delivered" {{$orders->deliver==1?"checked":""}}/>
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    ...
                                    <div class="pull-right">
                                        <h4><span>Total Amount:</span> #{{$orders->total}}</h4>
                                        <br>
