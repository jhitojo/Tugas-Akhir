    ...
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td>
          ...
          <form action="transaksi_seller/konfirmasi-cod/{{$p->id}}" method="post">
            {{ csrf_field() }}
        ...
        <td>
          <a href="/transaksi_seller/transaksi-detail/{{$p->id}}" class="btn btn-success btn-xs">Detail Pesanan</a>
        </td>
      </tr>
      @endforeach
    </table>
