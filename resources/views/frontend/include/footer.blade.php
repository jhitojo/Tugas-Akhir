                ...
                <div class="footer-newslater fix">
                    <div class="wrap fix">
                        ...
                        <form action="#">
                            ...
                            <button class="btn btn-sm btn-warning">SUBSCRIBE</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="copy-right">
                    <p>&copy; 2015 <a href="#">Intercore Solutions</a>, All Right Reserved</p>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="payment">
